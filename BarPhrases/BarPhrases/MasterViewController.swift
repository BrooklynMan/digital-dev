...
//  barPhrases
//
//  Created by adam mcbride on 3/4/16.
...
let kPhrases:String = "phrases"
let BLANK_NOTE:String = "(New Phrase)"
...
class MasterViewController: UITableViewController {
     ...
     override func viewDidLoad() {
          ...
          objects.append("goodbye")
          objects.append("what can i get you?")
          objects.append("neat or on the rocks?")
          objects.append("bottle or draft?")
     ...
     func save() {
          NSUserDefaults.standardUserDefaults().setObject(objects, forKey: kPhrases)
          NSUserDefaults.standardUserDefaults().synchronize()
     }
     
     func load() {
          if let loadedData = NSUserDefaults.standardUserDefaults().arrayForKey(kPhrases) as? [String] {
               objects = loadedData
          }
     }
